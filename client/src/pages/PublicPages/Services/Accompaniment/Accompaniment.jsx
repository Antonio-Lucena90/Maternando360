  ...
  return (
    <>
      <div className="page-hero">
        <h1>Acompañamiento a familias</h1>
        <p>
          Con hijos de 0 a 12 años. Desde una mirada global, respetuosa y basada en evidencia.
        </p>
      </div>

      <div className="accompaniment-intro">
        <p>
      ...
      <AccompanimentInfo currentInfo={currentInfo} id={1}>
        <div className='info-div'>
          ...
          <ul>
            ...
            <li>Acompañamiento a familias en momentos de duda, cambio o dificultad</li>
            <li>TEA.</li>
            <li>TDAH / TDH.</li>
            ...
            <li>Dificultades en el entorno escolar (organización, conducta, regulación emocional)</li>
          </ul>
        </div>
      </AccompanimentInfo>
      ...
      <AccompanimentInfo currentInfo={currentInfo} id={3}>
        <div className='info-div'>
          ...
          <ul>
            ...
            <li>Comunicación con el centro escolar (si la familia lo desea)</li>
          </ul>
