  ...
  return (
     <section className='my-container'>
        ...
        <div className="table">
          <table>
            <tbody>
              <tr>
                <td>
                  <h3>Asesoramiento Individual On-line</h3>
                  <button onClick={()=>setCurrentInfo(currentInfo === 1 ? null : 1)}>Ver info</button>
                  <RatesInfo currentInfo={currentInfo} id={1}>
                  <p>Un espacio 1:1 para resolver dudas concretas sobre tu hijo/a y tu familia.</p>
                  <p>Dirigidos a familias que buscan:</p>
                  <div className='d-flex flex-column justify-content-center align-items-center'>
                    <ul>
                      <li>Orientación sobre desarrollo infantil</li>
                      <li>Acompañamiento en regulación sensorial y emocional</li>
                      <li>Apoyo en autonomía, alimentación o rutinas</li>
                      <li>Comprensión de conductas que generan dudas o inseguridad</li>
                    </ul>
                  </div>
                  <h5>Precio: 
                    <p>55€ Sesión de 45 minutos</p>
            ...
            <tbody>
              <tr>
                <td>
                  ...
                  <button onClick={()=>setCurrentInfo(currentInfo === 2 ? null : 2)}>Ver info</button>
                  <RatesInfo currentInfo={currentInfo} id={2}>
                  <p>Sesión presencial para familias que prefieren un acompañamiento cercano y directo</p>
                  <p>Indicada para:</p>
                  <div className='d-flex flex-column justify-content-center align-items-center'>
                    <ul>
                      <li>Valoración más profunda del día a día familiar</li>
                      <li>Observación del niño en su entorno</li>
                      <li>Acompañamiento en momentos de cambio o dificultad</li>
                    </ul>
                  </div>
                  <h5>Precio: 
                    <p>65€ Sesión de 60 minutos</p>
            ...
            <tbody>
              <tr>
                <td>
                  ...
                  <button onClick={()=>setCurrentInfo(currentInfo === 3 ? null : 3)}>Ver Info</button>
                  <RatesInfo currentInfo={currentInfo} id={3}>
                   <p>Pensado para familias que necesitan algo más que una sesión puntual</p>
            ...
            <tbody>
              <tr>
                <td>
                  ...
                  <button onClick={()=>setCurrentInfo(currentInfo === 4 ? null : 4)}>Ver info</button>
                  <RatesInfo currentInfo={currentInfo} id={4}>
                      <p>Un acompañamiento intensivo y cercano para familias que necesiten sostén continuo.</p>
                  <p>Incluye:</p>
                  <div className='d-flex flex-column justify-content-center align-items-center'>
                    <ul>
                      <li>3 Sesiones On-Line personalizadas.</li>
                      <li>Resolución de dudas por Whatsapp de lunes a viernes.</li>
                  ...
                  <div className='d-flex flex-column justify-content-center align-items-center'>
                    <ul>
                      ...
                      <li>Familias que necesitan sentirse acompañadas en el día a día.</li>
                    </ul>
                  </div>
                  <h5>Precio: 
      ...
      <div className='cita'>
        ...
        <ol>
          <li>Envía un E-Mail a maternando@gmail.com y nos pondremos en contacto con usted.</li>
      ...
      <div className='cancelacion'>
        ...
        <ul>
          ...
          <li>Cancelación con menos de 24h o ausencia sin aviso se considerará realizada.</li>
